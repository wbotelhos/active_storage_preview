...
ActiveStoragePreview.prototype = {
  ...
  parameterize: function(value) {
    ...
    return value.trim().toLowerCase().replace(/\s|\./g, '-').replace(/[^a-zA-Z0-9 -]/, '');
  },
